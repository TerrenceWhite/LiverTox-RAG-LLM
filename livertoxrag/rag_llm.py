...
# Initialize Claude API client if key is available
...
def answer_question(query, index, metadata, top_k=10, target_drug=None, return_chunks=False, 
    ...
    if query_drugs:
        ...
        if drug_specific_chunks:
            # Create temporary embeddings just for the drug-specific chunks
            ...
            # Create temporary index for drug-specific chunks
            ...
            print(f"WARNING: No chunks found for drugs {query_drugs}. Falling back to general search.")
    ...
    print("\nDEBUG: Checking retrieved chunks for content")
    ...
    print(f"\nDEBUG: Context size for {llm_type.upper()}: {len(context)} characters")
    ...
    print(f"DEBUG: Modified question: {combined_question}")
...
Your answer should be concise, factual, and based solely on the information in the context. If the answer isn't clearly stated in the context, indicate this."""
        ...
        print(f"DEBUG: Prompt length for OpenAI: {len(openai_prompt)} characters")
        ...
        try:
            ...
            print(f"DEBUG: Raw OpenAI answer length: {len(answer)} characters")
            print(f"DEBUG: Raw OpenAI answer preview: {answer[:100]}...")
...
Your answer should be concise, factual, and based solely on the information in the context. If the answer isn't clearly stated in the context, indicate this."""
        ...
        print(f"DEBUG: Prompt length for Claude: {len(claude_prompt)} characters")
        ...
        try:
            ...
            print(f"DEBUG: Raw Claude answer length: {len(answer)} characters")
            print(f"DEBUG: Raw Claude answer preview: {answer[:100]}...")
        ...
        print(f"DEBUG: Prompt length for local LLM: {len(prompt)} characters")
        ...
        try:
            ...
            print(f"DEBUG: Raw LLM answer length: {len(answer)} characters")
            print(f"DEBUG: Raw LLM answer preview: {answer[:100]}...")
